...
**To add a project**, simply add a new directory like [Oceananigans](./Oceananigans/) with a Project.toml and [check.jl](./Oceananigans/check.jl) script. All subdirectories with `check.jl` files are automatically included in the integration tests and run as part of CI.
